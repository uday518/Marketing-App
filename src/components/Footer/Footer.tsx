      ...
      <div className="mx-auto max-w-[1448px] px-6 lg:px-12">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[1fr_repeat(4,160px)]">
          <div className="lg:col-span-1">
            ...
            <p className="mt-3 max-w-[260px] text-[13px] text-[#8099a6]">
          ...
          {columns.map((col) => (
            <div key={col.title}>
              ...
              <ul className="mt-4 flex flex-col gap-3 text-[13px] text-[#8099a6]">
                {col.links.map((link) => (
                  <li key={link.label}>
        ...
        <hr className="my-10 border-[#143240]" />

        <div className="flex flex-col items-center justify-between gap-3 text-xs text-[#66808c] sm:flex-row">
