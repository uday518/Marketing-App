...
const tabs = [
  ...
  { label: 'Reports', href: '/product/features/reports-analytics', active: true },
  { label: 'Multi-Clinic', href: '/product/features/multi-clinic-management' },
  { label: 'Security', href: '/product/features/security' },
];

export default function ReportsAnalyticsHero() {
  return (
    <section className="bg-secondary-100 px-6 py-16">
      <div className="mx-auto max-w-7xl">
        ...
        <nav className="mb-8 text-sm text-neutral-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-neutral-700">Reports &amp; Analytics</span>
        </nav>
        ...
        <div className="flex flex-col items-start gap-12 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex max-w-xl flex-col items-start gap-6">
            <h1 className="text-4xl font-bold leading-tight text-neutral-900 lg:text-5xl">
              See What&apos;s Happening Across Your Entire Practice
            </h1>

            <p className="text-lg text-neutral-500">
              Real-time dashboards and exportable reports that help clinic owners
              and managers make confident decisions.
            </p>
          ...
          <div className="flex w-full max-w-lg">
            <div className="flex h-72 w-full items-center justify-center rounded-2xl bg-white shadow-xl">
              <span className="text-sm text-neutral-400">Reports &amp; Analytics screenshot</span>
            </div>
          </div>
        </div>
      </div>
