...
const features = [
  ...
  },
  {
    ...
    description: 'Multi-step plans, tracked to completion.',
  ...
  },
  {
    ...
    description: 'Roles and permissions, per clinic.',
  ...
  },
  {
    ...
    description: 'Real-time dashboards, exportable.',
  ...
  },
  {
    ...
    description: 'One account, every location.',
  ...
  },
  {
    ...
    description: 'Tenant isolation, encrypted data.',
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold text-text-heading lg:text-4xl">
            A Complete System, Not a Collection of Tools
          </h2>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            ...
            >
              {feature.icon}
              <h3 className="text-base font-semibold text-text-heading">{feature.title}</h3>
              <p className="text-[13px] text-text-muted">{feature.description}</p>
            </Link>
          ))}
        </div>
      </div>
