...
const tabs = [
  ...
  { label: 'Queue', href: '/product/features/queue-management', active: true },
...
export default function QueueMgmtHero() {
  return (
    <section className="bg-secondary-100 px-6 py-16">
      <div className="mx-auto max-w-7xl">
        ...
        <nav className="mb-8 text-sm text-neutral-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-neutral-700">Queue Management</span>
        </nav>
        ...
        <div className="flex flex-col items-start gap-12 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex max-w-xl flex-col items-start gap-6">
            <h1 className="text-4xl font-bold leading-tight text-neutral-900 lg:text-5xl">
              Turn Waiting Rooms Into Waiting Lists
            </h1>

            <p className="text-lg text-neutral-500">
              Real-time queue visibility for your front desk and clinical staff — so nobody waits longer than they should.
            </p>
          ...
          <div className="flex w-full max-w-lg">
            <div className="flex h-72 w-full items-center justify-center rounded-2xl bg-white shadow-xl">
              <span className="text-sm text-neutral-400">Queue Management screenshot</span>
            </div>
          </div>
        </div>
      </div>
