const steps = [
  {
    ...
    description: 'Arrives for a 10am appointment.',
  },
  {
    number: 2,
    title: 'Checked In',
    description: 'Receptionist marks them Checked In.',
  },
  {
    number: 3,
    title: 'Marked Ready',
    description: 'Dentist sees the patient move to Ready on the queue board.',
  },
  {
    number: 4,
    title: 'Called',
    description: 'Dentist calls the patient from the dashboard.',
  },
];

export default function QueueMgmtWorkflow() {
  return (
